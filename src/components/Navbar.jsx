...
function Navbar() {
  ...
  return (
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#13131c] text-gray-300'>
        <div>
        ...
        {/* menu */}
            ...
            <ul className='hidden md:flex'>
                ...
                <li>
                <Link to="ProjectInfo" smooth={true} duration={500} className='text-white'>
                ProjectInfo
                </Link>
                </li>
            </ul>
